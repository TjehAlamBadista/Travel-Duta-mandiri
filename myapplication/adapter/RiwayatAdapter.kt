...
class RiwayatAdapter (var mContext: Context,
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tvKategori.text = "Mobil " + data.jenisMobil
        holder.tvBerat.text = "Orang : " + data.orang.toString()
        holder.tvSaldo.text = "Biaya : " + rupiahFormat(data.harga)
