...
import com.example.myapplication.view.InputDataActivity
import com.example.myapplication.view.JenisActivity
import com.example.myapplication.view.RiwayatActivity
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setInitLayout() {
        ...
        cvKategori.setOnClickListener { v: View? ->
            val intent = Intent(this@MainActivity, JenisActivity::class.java)
            startActivity(intent)
        }
