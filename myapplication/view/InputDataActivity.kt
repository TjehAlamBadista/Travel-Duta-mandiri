...
import com.example.myapplication.utils.FunctionHelper.rupiahFormat
...
class InputDataActivity : AppCompatActivity() {
    ...
    private fun setInitLayout() {
        strKategori = resources.getStringArray(R.array.kategori_mobil)
        strHarga = resources.getStringArray(R.array.harga_perorang)
    ...
    private fun setInputData() {
        btnCheckout.setOnClickListener { v: View? ->
            ...
            if (strNama.isEmpty() or strTanggal.isEmpty() or strAlamat.isEmpty() or (strKategori.size == 0) or (countHarga == 0)) {
                Toast.makeText(
